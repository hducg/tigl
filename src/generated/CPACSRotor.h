...
namespace generated
{
    ...
    /// fenestron, propeller,...) of an rotorcraft model.</para>
    /// </summary>
    /// <remarks>
    /// <content>
    /// <para>
    ...
    /// systems:</para>
    /// <mediaLink>
    /// <image href="rotor_cs01">
    /// </image>
    /// </mediaLink>
    /// <list class="bullet">
    /// <listItem>
    /// The origin coincides with the center of rotation.</listItem>
    /// <listItem>
    ...
    /// a main rotor, forwards for a propeller).</listItem>
    /// <listItem>
    /// The x-axis points from nose to tail (usually
    /// rearwards for main and tail rotors, upwards for a propeller).</listItem>
    /// <listItem>
    /// The y-axis completes the right-handed orthogonal
    /// coordinate system.</listItem>
    /// </list>
    /// <para>
    /// Rotor hub attributes, hinges and references to
    /// attached rotor blades are defined in the rotorHub element.</para>
    /// <para>
    ...
    /// ) and wingType (
    /// ) for information on the definition of rotor blade geometries.<xmlEntityReference>
    /// </xmlEntityReference>
    /// Note that rotor blade geometries are only referenced and not
    /// defined in the child nodes of the rotor element. Refer to the
    /// documentation of rotorBladesType (
    ...
    /// documentation of rotorBladesType (
    /// ) and wingType (
    /// ) for information on the definition of rotor blade geometries.</para>
    /// <para>
    ...
    /// hinge: hingeDeflection given):</para>
    /// <mediaLink>
    /// <image href="rotor_transformation">
    /// </image>
    /// </mediaLink>
    /// </content>
    /// </remarks>
