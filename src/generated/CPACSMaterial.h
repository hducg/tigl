...
namespace generated
{
    ...
    /// defined</listItem>
    /// <listItem>
    /// transversal isotropic material like
    /// uni-directional layers of CFRP may be defined</listItem>
    /// <listItem>
    /// orthotrop material like several layers of CFRP may
    /// be defined</listItem>
    /// </list>
    /// <para>
    /// For each material behaviour the minimum number of
    /// stiffness parameters are requested. All other stiffness
    /// components are dependent by material symmetry relationships.</para>
    /// </remarks>
    class CPACSMaterial
    {
    public:
