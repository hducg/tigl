...
namespace generated
{
    ...
    /// <remarks>
    /// <para>
    /// Point type, containing a z data.</para>
    /// </remarks>
    class CPACSPointZ
    {
    public:
        TIGL_EXPORT CPACSPointZ(CTiglUIDManager* uidMgr);
...
#else
        CPACSPointZ(const CPACSPointZ&);
        CPACSPointZ& operator=(const CPACSPointZ&);
#endif
    };
} // namespace generated
...
#else
typedef generated::CPACSPointZ CCPACSPointZ;
#endif
} // namespace tigl
