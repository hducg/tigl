...
namespace generated
{
    ...
    /// <summary>
    /// <para>
    /// Trailing edge device of the wing.</para>
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// are not included into a track, can be defined in actuators.</para>
    /// <para>
    ...
    /// modeled in the control surface.</para>
    /// <para>
    ...
    /// of the edge that is within the wing in absolute coordinates.</para>
    /// </remarks>
